            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 w-full">
                ...
                <div className="space-y-2">
                    <label htmlFor="username" className="text-sm font-medium text-gray-700">
                        Username <span className="text-red-500 text-xs">(max 8 karakter)</span>
                    </label>
                    <input
                        id="username"
                        {...register('username', { required: 'Username wajib diisi', maxLength: { value: 8, message: 'Username maksimal 8 karakter' } })}
